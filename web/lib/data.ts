...
export const upcomingExams: UpcomingExam[] = [
  ...
  },
  {
    id: "math-210-quiz",
    courseCode: "MATH 210",
    title: "Шугаман алгебр - Явцын шалгалт",
    date: "2026-04-08",
...
export const grades: CourseGrade[] = [
  {
    ...
    currentGrade: 88,
    exams: [
      { name: "Явцын шалгалт 1", score: 18, maxScore: 20, weight: 10 },
      { name: "Сорил", score: 84, maxScore: 100, weight: 30 },
  ...
  },
  {
    ...
    currentGrade: 81,
    exams: [
      { name: "Явцын шалгалт 1", score: 16, maxScore: 20, weight: 10 },
      { name: "Явцын шалгалт 2", score: 14, maxScore: 20, weight: 10 },
      { name: "Сорил", score: 76, maxScore: 100, weight: 30 },
  ...
  },
  {
    ...
    exams: [
      ...
      { name: "Сорил", score: 90, maxScore: 100, weight: 30 },
